...
define(["require", "exports", 'react', 'Framework/Signum.React/Scripts/Navigator', 'Framework/Signum.React/Scripts/TypeContext', 'Framework/Signum.React/Scripts/Signum.Entities', 'Framework/Signum.React/Scripts/Reflection'], function (require, exports, React, Navigator, TypeContext_1, Signum_Entities_1, Reflection_1) {
    var NormalControl = (function (_super) {
        ...
        NormalControl.prototype.render = function () {
            ...
            var ctx = new TypeContext_1.TypeContext(null, styleOptions, Reflection_1.PropertyRoute.root(typeInfo), new Reflection_1.ReadonlyBinding(this.state.entity));
            return (React.createElement("div", {"className": "normal-control"}, this.renderTitle(typeInfo), Navigator.renderWidgets({ entity: this.state.entity }), React.createElement("div", {"className": "btn-toolbar sf-button-bar"}, Navigator.renderButtons({ entity: this.state.entity, canExecute: this.state.canExecute })), this.renderValidationErrors(), Navigator.renderEmbeddedWidgets({ entity: this.state.entity }, Navigator.EmbeddedWidgetPosition.Top), React.createElement("div", {"id": "divMainControl", "className": "sf-main-control", "data-test-ticks": new Date().valueOf()}, this.state.component && React.createElement(this.state.component, { ctx: ctx })), Navigator.renderEmbeddedWidgets({ entity: this.state.entity }, Navigator.EmbeddedWidgetPosition.Bottom)));
        };
