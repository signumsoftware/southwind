define(["require", "exports", "moment", "react-widgets"], function (require, exports, moment, react_widgets_1) {
    function configure() {
        if (typeof moment !== 'function')
            throw new TypeError('You must provide a valid moment object');
        var localField = typeof moment().locale === 'function' ? 'locale' : 'lang', hasLocaleData = !!moment.localeData;
        if (!hasLocaleData)
        ...
        react_widgets_1.setDateLocalizer(localizer);
    }
    exports.configure = configure;
});
//# sourceMappingURL=ConfigureReactWidgets.js.map